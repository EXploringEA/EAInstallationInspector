...
Source code for the [EXploringEA.com's]([http://EXploringEA.com](https://exploringea.co.uk/tools/index.php/EAInspector/EAInspector.html) "EXploringEA") EA Installation Inspector 
